...
//time
const xtime = moment.tz('Africa/NIGER').format('HH:mm:ss')
        const xdate = moment.tz('Africa/NIGER').format('DD/MM/YYYY')
        const time2 = moment().tz('Africa/NIGER').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./kawakiMedia/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`𝙱𝚘𝚝 𝚎𝚗 𝚕𝚒𝚐𝚗𝚎 𝟸𝟺𝚑/𝟸𝟺 𝚎𝚝 𝟽𝚓/𝟽 𝚙𝚊𝚛 𝙺𝙰𝚆𝙰𝙺𝙸-𝙱𝚄𝙶 𝙱𝚘𝚝 𝙾𝚠𝚗𝚎𝚛 : ${ownername} 𝙿𝚘𝚞𝚛 𝚙𝚕𝚞𝚜 𝚍𝚎 𝚑𝚊𝚌𝚔𝚜, 𝚛𝚎𝚌𝚑𝚎𝚛𝚌𝚑𝚎𝚣 𝚜𝚞𝚛 𝚈𝚘𝚞𝚝𝚞𝚋𝚎 𝙺𝙰-𝚆𝙰-𝙺𝙸`).catch(_ => _)
        }
...
let audiobuffy = fs.readFileSync(`./kawakiMedia/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./kawakiMedia/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./kawakiMedia/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./kawakiMedia/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kawakiMedia/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kawakiMedia/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./kawakiMedia/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
    ...
    case 'autostatusview':{
            ...
            case 'getcase':
                if (!isCreator) return replygcxeon(mess.owner)
                const getCase = (cases) => {
                    return "case" + `'${cases}'` + fs.readFileSync("KAWAKI-BUG-BOT-.js").toString().split('case \'' + cases + '\'')[1].split("break")[0] + "break"
                }
    ...
    await XeonBotInc.sendMessage(m.chat, {
        ...
        quoted: m
            ...
            case 'donasi':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    text: '*Don de soutien pour KAWAKI*\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
break
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./kawakiMedia/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./kawakiMedia/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./kawakiMedia/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./kawakiMedia/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./kawakiMedia/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./kawakiMedia/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./kawakiMedia/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./kawakiMedia/audio/${q}.mp3`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./kawakiMedia/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./kawakiMedia/zip/${teks}.zip`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./kawakiMedia/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./kawakiMedia/apk/${teks}.apk`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./kawakiMedia/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./kawakiMedia/doc/${teks}.pdf`)
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./kawakiMedia/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
