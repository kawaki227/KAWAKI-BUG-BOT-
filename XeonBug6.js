...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`𝙱𝚘𝚝 𝚎𝚗 𝚕𝚒𝚐𝚗𝚎 𝟸𝟺𝚑/𝟸𝟺 𝚎𝚝 𝟽𝚓/𝟽 𝚙𝚊𝚛 𝙺𝙰𝚆𝙰𝙺𝙸 𝙱𝚘𝚝 𝙾𝚠𝚗𝚎𝚛 : ${ownername} 𝙿𝚘𝚞𝚛 𝚙𝚕𝚞𝚜 𝚍𝚎 𝚑𝚊𝚌𝚔𝚜, 𝚛𝚎𝚌𝚑𝚎𝚛𝚌𝚑𝚎𝚣 𝚜𝚞𝚛 𝚈𝚘𝚞𝚝𝚞𝚋𝚎 𝙺𝙰𝚆𝙰𝙺𝙸`).catch(_ => _)
        }
...
case 'ping': {
    ...
    await XeonBotInc.sendMessage(m.chat, {
        ...
        quoted: m
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `*Salut ${pushname}\n Premium est payant ! \n Met ton numéro dans Premium json file! \n et dépôt à 𝙺𝙰𝚆𝙰𝙺𝙸 pour l'activer on Youtube channel 𝙺𝙰-𝚆𝙰-𝙺𝙸*`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'runtime':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `Yt 𝙺𝙰𝚆𝙰𝙺𝙸-parker-tech`,
                            body: `Love from 𝙺𝙰𝚆𝙰𝙺𝙸 🩵`,
                            thumbnailUrl: 'https://telegra.ph/file/012c279b7380afc26d821.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donasi':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    text: '*Don de soutien pour 𝙺𝙰𝚆𝙰𝙺𝙸*\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./xoneMedia/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
